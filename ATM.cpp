...
// start ATM
void ATM::run(){
// menyambut dan mengotentikasi pengguna; melakukan transaksi
	while ( true ){
// loop sementara pengguna belum diautentikasi
		while ( !userAuthenticated ){
		screen.displayMessageLine( "Welcome!" );
		authenticateUser(); // otentikasi pengguna
		} // end while
...
void ATM::performTransactions(){
	...
	// determine which type of Transaction to create 
		...
		3.	tempPtr = new Deposit( currentAccountNumber, screen,bankDatabase, keypad, depositSlot );
			break;
		} // end switch
